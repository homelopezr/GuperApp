...
public class RecursosView extends JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(guperapp.GuperApp.class).getContext().getResourceMap(RecursosView.class);
        ...
        if (masterTable.getColumnModel().getColumnCount() > 0) {
            ...
            masterTable.getColumnModel().getColumn(1).setMinWidth(60);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(funCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                                    .addComponent(salarioRealField, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                                    .addComponent(ipsField, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                                    .addComponent(vacacionesField, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                                    .addComponent(indemnizacionField, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)))
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<guperapp.Recursos> toRemove = new ArrayList<guperapp.Recursos>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            guperapp.Recursos r = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(r);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        guperapp.Recursos r = new guperapp.Recursos();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<guperapp.Recursos> merged = new ArrayList<guperapp.Recursos>(list.size());
            for (guperapp.Recursos r : list) {
    ...
    private java.util.List<guperapp.Recursos> list;
