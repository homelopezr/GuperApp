...
public class ClienteView extends JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(guperapp.GuperApp.class).getContext().getResourceMap(ClienteView.class);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<guperapp.Cliente> toRemove = new ArrayList<guperapp.Cliente>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            guperapp.Cliente c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        guperapp.Cliente c = new guperapp.Cliente();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<guperapp.Cliente> merged = new ArrayList<guperapp.Cliente>(list.size());
            for (guperapp.Cliente c : list) {
    ...
    private java.util.List<guperapp.Cliente> list;
