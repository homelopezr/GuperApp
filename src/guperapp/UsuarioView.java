...
public class UsuarioView extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("guper?zeroDateTimeBehavior=convertToNullPU").createEntityManager();
        ...
        usuCodigoLabel.setText("Usu Codigo:");

        usuNombreLabel.setText("Usu Nombre:");

        usuClaveLabel.setText("Usu Clave:");

        usuNivelLabel.setText("Usu Nivel:");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<guperapp.Usuario> toRemove = new ArrayList<guperapp.Usuario>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            guperapp.Usuario u = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(u);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        guperapp.Usuario u = new guperapp.Usuario();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<guperapp.Usuario> merged = new ArrayList<guperapp.Usuario>(list.size());
            for (guperapp.Usuario u : list) {
    ...
    private java.util.List<guperapp.Usuario> list;
