...
public class EquipoView extends JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(guperapp.GuperApp.class).getContext().getResourceMap(EquipoView.class);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<guperapp.Equipo> toRemove = new ArrayList<guperapp.Equipo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            guperapp.Equipo e = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(e);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        guperapp.Equipo e = new guperapp.Equipo();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<guperapp.Equipo> merged = new ArrayList<guperapp.Equipo>(list.size());
            for (guperapp.Equipo e : list) {
    ...
    private java.util.List<guperapp.Equipo> list;
