...
public class VentaView extends JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(guperapp.GuperApp.class).getContext().getResourceMap(VentaView.class);
        ...
        if (masterTable.getColumnModel().getColumnCount() > 0) {
            ...
            masterTable.getColumnModel().getColumn(4).setMinWidth(50);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(venCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                                    .addComponent(cliCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                                    .addComponent(proCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                                    .addComponent(proCantidadField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                                    .addComponent(proPrecioVentaField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                                    .addComponent(venTotalField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                                    .addComponent(funCodigoField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)))
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<guperapp.Venta> toRemove = new ArrayList<guperapp.Venta>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            guperapp.Venta v = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(v);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        guperapp.Venta v = new guperapp.Venta();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<guperapp.Venta> merged = new ArrayList<guperapp.Venta>(list.size());
            for (guperapp.Venta v : list) {
    ...
    private java.util.List<guperapp.Venta> list;
