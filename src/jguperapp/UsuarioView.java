...
public class UsuarioView extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<jguperapp.Usuario> toRemove = new ArrayList<jguperapp.Usuario>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            jguperapp.Usuario u = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(u);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        jguperapp.Usuario u = new jguperapp.Usuario();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<jguperapp.Usuario> merged = new ArrayList<jguperapp.Usuario>(list.size());
            for (jguperapp.Usuario u : list) {
    ...
    private java.util.List<jguperapp.Usuario> list;
