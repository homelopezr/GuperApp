...
public class RecursosView extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<jguperapp.Recursos> toRemove = new ArrayList<jguperapp.Recursos>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            jguperapp.Recursos r = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(r);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        jguperapp.Recursos r = new jguperapp.Recursos();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<jguperapp.Recursos> merged = new ArrayList<jguperapp.Recursos>(list.size());
            for (jguperapp.Recursos r : list) {
    ...
    private java.util.List<jguperapp.Recursos> list;
