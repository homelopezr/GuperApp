...
public class ServivioView extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<jguperapp.Servicio> toRemove = new ArrayList<jguperapp.Servicio>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            jguperapp.Servicio s = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(s);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        jguperapp.Servicio s = new jguperapp.Servicio();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<jguperapp.Servicio> merged = new ArrayList<jguperapp.Servicio>(list.size());
            for (jguperapp.Servicio s : list) {
    ...
    private java.util.List<jguperapp.Servicio> list;
